    ...
    >
      <nav className="absolute top-0 left-0 w-full bg-transparent p-4 flex justify-between items-center shadow-md z-10">
        ...
        <div className="flex space-x-6 items-center">
          ...
          <a href="/login" className="px-4 py-2 text-white font-semibold text-lg hover:underline">Login</a>
          <a href="/register" className="px-4 py-2 text-white font-semibold text-lg hover:underline">Register</a>
        </div>
      </nav>
    </div>
  );
